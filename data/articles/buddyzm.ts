...
export const buddyzm: ArticleGroup = {
  topic: "buddyzm",
  topicTitle: "Buddyzm",
  topicIntro: "Shorinji Kempo opiera swoją filozofię na buddyjskich naukach Kongō Zen. Sekcja prezentuje podstawowe pojęcia buddyzmu, kluczowe nauki, system medytacji oraz buddyjską etykę i kalendarz.",
  articles: [
{
  slug: "podstawy",
  title: "Podstawy buddyzmu",
  intro: "Czym jest buddyzm, kim był Budda i czego naucza – kluczowe informacje dla każdego, kto wchodzi w świat tej tradycji.",
  sections: [
  {
    heading: "Czym jest buddyzm?",
    paragraphs: [
...
{
  slug: "nauki",
  title: "Cztery Prawdy, Ośmioraka Ścieżka, Trzy Klejnoty",
  intro: "Cztery Szlachetne Prawdy, Szlachetna Ośmioraka Ścieżka, Potrójna droga i Trzy Klejnoty – fundamenty praktyki buddyjskiej.",
  sections: [
  {
    heading: "Cztery Szlachetne Prawdy",
    paragraphs: [
...
{
  slug: "medytacja",
  title: "Medytacja i ścieżka praktyki",
  intro: "Czym jest medytacja, jak wygląda buddyjski system medytacyjny i jak prowadzi ścieżka praktyki.",
  sections: [
  {
    heading: "Czym jest medytacja?",
    paragraphs: [
...
{
  slug: "etyka-i-swieta",
  title: "Etyka i święta buddyjskie",
  intro: "Czym jest etyka buddyjska i jakie święta wyznaczają kalendarz tradycji.",
  sections: [
  {
    heading: "Czym jest etyka buddyjska?",
    paragraphs: [
      ...
      "Jakie masz uczucie, kiedy coś komuś dajesz? Jak się czujesz, kiedy coś dostajesz (np. prezent)? Czy czujesz czasem opór przed dawaniem? Czy chcesz, żeby to, co dajesz, zostało docenione? Jeśli nie jesteś w stanie dać od serca, to lepiej nie dawaj, bo potem możesz żałować. Jak przyjmować, coś co jest nam dane?",
      ...
      "„Jeśli wiesz coś, co jest szkodliwe i nieprawdziwe, nie mów tego. Jeśli wiesz coś, co jest pomocne i nieprawdziwe, nie mów tego. Jeśli wiesz coś, co jest szkodliwe i prawdziwe, nie mów tego Jeśli wiesz coś, co jest pomocne i prawdziwe, znajdź dobrą porę, by to powiedzieć.\" (Budda)",
  ...
  },
  {
    ...
    paragraphs: [
      ...
      "Buddyjskie święta czczą przede wszystkim „Trzy Klejnoty\" czyli Buddę, Dharmę (buddyjskie nauki) oraz Sanghę (wspólnotę duchową).",
      ...
      "W Dzień Sanghi buddyści oddają cześć zarówno tej idealnej wspólnocie duchowej, jak i tej istniejącej lub tworzonej przez nich samych. Dzień Sanghi to czas dawania prezentów i choć na Wschodzie nie odgrywa większej roli, to wśród buddystów na Zachodzie cieszy się on dużym powodzeniem.",
