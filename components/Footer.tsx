        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              {/* Facebook */}
              <Link
                href="https://www.facebook.com/shorinjikempopolska"
                aria-label="Facebook"
              ...
              {/* Instagram */}
              <Link
                href="https://www.instagram.com/shorinjikempopolska/"
              ...
              {/* YouTube */}
              <Link
                href="https://www.youtube.com/@Dominik_Chowanski"
                aria-label="YouTube"
                className="text-neutral-400 hover:text-yellow-500 transition-colors"
              >
                <svg className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
          ...
          {/* Kolumna 2: Do pobrania */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-4 tracking-wider">DO POBRANIA</h3>
          ...
          {/* Kolumna 3: Dokumenty */}
          <div>
            <h3 className="text-white text-lg font-semibold mb-4 tracking-wider">DOKUMENTY</h3>
            <ul className="space-y-2 text-sm">
              {dokumenty.map((d) => (
                <li key={d.href}>
                  <Link
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm text-neutral-400 leading-relaxed">
              <li>
                ul. Łąkowa 31, Kraków
                <br />
                <span className="text-neutral-500">Szkoła Podstawowa nr 114</span>
              </li>
              <li>
                <a href="tel:+48792995510" className="hover:text-yellow-500 transition-colors">
                  +48 792 99 55 10
                </a>
              </li>
              <li>
