      ...
      >
        <div className="w-[80%] mx-auto">
          ...
          <div className="flex justify-between items-center py-4 border-b border-neutral-900">
            ...
            {/* Ikony social – te same co w stopce: FB / IG / YT + e-mail */}
              ...
              <div key={link.label} className="relative group">
                ...
                {link.dropdown ? (
                  <>
                    ...
                    {/* Dropdown – pt-2 tworzy "mostek" hover między buttonem a menu,
                        żeby kursor nie tracił grupy przy zjeżdżaniu w dół. */}
