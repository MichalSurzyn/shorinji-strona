...
/**
 * Renderer bloków treści (ciemny motyw strony).
        ...
        switch (block.type) {
          ...
          case "subheading":
            return (
              <h3
                key={i}
                className="text-xl md:text-2xl font-semibold text-white pt-2"
              >
                <InlineText text={block.text} />
              </h3>
            );
          ...
          case "callout":
            return (
              <div
                key={i}
                className="rounded-xl border border-yellow-500/40 bg-yellow-500/5 px-6 py-5 text-neutral-200 backdrop-blur-sm"
              >
                <InlineText text={block.text} />
              </div>
            );
          case "quote":
            return (
              <blockquote
                key={i}
                className="border-l-4 border-yellow-500/60 pl-5 italic text-neutral-200"
              >
                <InlineText text={block.text} />
              </blockquote>
            );
          ...
          case "image": {
            ...
            return (
              <figure key={i} className={`pt-2 ${portrait ? "max-w-md" : ""}`}>
          ...
          case "gallery":
            return (
              <div key={i} className="grid grid-cols-2 md:grid-cols-3 gap-4 pt-2">
          ...
          case "table": {
            ...
            return (
              <div
                key={i}
                className="rounded-xl border border-yellow-500/60 overflow-hidden bg-transparent backdrop-blur-sm"
              >
